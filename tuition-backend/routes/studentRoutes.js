...
// @route   GET /api/students/by-class/:className
// @desc    Get all students in a specific class (for attendance)
// @access  Public
router.get("/by-class/:className", async (req, res) => {
  try {
    ...
    // Find all approved and active students in this class
...
// @route   PUT /api/student/:id/payment
